...
export default function NewProjectScreen() {
  ...
  const validateForm = () => {
    ...
    if (!name.trim()) {
      setNameError(t('projects.name') + t('common.required'));
      isValid = false;
    } else {
      setNameError('');
    }
    ...
    if (!description.trim()) {
      setDescriptionError(t('projects.description') + t('common.required'));
      isValid = false;
    } else {
      setDescriptionError('');
    }
    ...
    if (!location.trim()) {
      setLocationError(t('projects.location') + t('common.required'));
      isValid = false;
    } else {
      setLocationError('');
    }
    ...
    if (!startDate) {
      setStartDateError(t('projects.start.date') + t('common.required'));
      isValid = false;
    } else {
      setStartDateError('');
    }
    ...
    if (enableCarbonBudget && !totalCarbonBudget.trim()) {
      setCarbonBudgetError(t('projects.carbon.budget.total') + t('common.required'));
      isValid = false;
    } else {
