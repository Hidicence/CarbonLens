        ...
        <View style={styles.quickActionsSection}>
          ...
          >
            ...
            <View style={styles.quickActionContent}>
              <Text style={[styles.quickActionTitle, { color: Colors.dark.text }]}>專案器材</Text>
          ...
          <View style={[styles.shootingDaySection, { backgroundColor: Colors.dark.card }]}>
            <View style={styles.shootingDayHeader}>
              ...
              <View style={styles.quickActionContent}>
                <Text style={[styles.quickActionTitle, { color: Colors.dark.text }]}>拍攝日記錄</Text>
                <Text style={[styles.quickActionDesc, { color: Colors.dark.secondaryText }]}>
                  按工作組別記錄拍攝活動
                </Text>
          </View>
            ...
            <View style={styles.crewButtonsGrid}>
              ...
              >
                ...
                <Text style={[styles.crewButtonText, { color: '#FF6B6B' }]}>導演組</Text>
              </Pressable>
              ...
              >
                ...
                <Text style={[styles.crewButtonText, { color: '#4ECDC4' }]}>攝影組</Text>
              </Pressable>
                ...
                <Text style={[styles.crewButtonText, { color: '#FFE66D' }]}>燈光組</Text>
              </Pressable>
              ...
              >
                ...
                <Text style={[styles.crewButtonText, { color: '#A8E6CF' }]}>收音組</Text>
              </Pressable>
              ...
              >
                ...
                <Text style={[styles.crewButtonText, { color: '#FFB3BA' }]}>梳化組</Text>
              </Pressable>
                ...
                <Text style={[styles.crewButtonText, { color: '#D4E6B7' }]}>製片組</Text>
                  </Pressable>
            </View>
          </View>
        </View>
